...
public class KafkaBrokerConfigurationBuilderTest {
    ...
    public void testCruiseControl()  {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                CruiseControlConfigurationParameters.METRICS_REPORTER_BOOTSTRAP_SERVERS + "=my-cluster-kafka-brokers:9096",
    ...
    public void testWithNoListeners() {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "listener.name.replication-9096.ssl.keystore.location=/tmp/kafka/cluster.keystore.p12",
                "listener.name.replication-9096.ssl.keystore.password=${CERTS_STORE_PASSWORD}",
                "listener.name.replication-9096.ssl.keystore.type=PKCS12",
                "listener.name.replication-9096.ssl.truststore.location=/tmp/kafka/cluster.truststore.p12",
                "listener.name.replication-9096.ssl.truststore.password=${CERTS_STORE_PASSWORD}",
                "listener.name.replication-9096.ssl.truststore.type=PKCS12",
                "listener.name.replication-9096.ssl.client.auth=required",
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096",
                "advertised.listeners=CONTROLPLANE-9090://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL",
                "control.plane.listener.name=CONTROLPLANE-9090",
                "inter.broker.listener.name=REPLICATION-9096",
    ...
    public void testConnectionLimits()  {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,LISTENER1-9100://0.0.0.0:9100,LISTENER2-9101://0.0.0.0:9101,LISTENER3-9102://0.0.0.0:9102,LISTENER4-9103://0.0.0.0:9103",
                "advertised.listeners=CONTROLPLANE-9090://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096,LISTENER1-9100://dummy-advertised-address:1919,LISTENER2-9101://dummy-advertised-address:1919,LISTENER3-9102://dummy-advertised-address:1919,LISTENER4-9103://dummy-advertised-address:1919",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,LISTENER1-9100:PLAINTEXT,LISTENER2-9101:PLAINTEXT,LISTENER3-9102:PLAINTEXT,LISTENER4-9103:PLAINTEXT",
                "control.plane.listener.name=CONTROLPLANE-9090",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
                "ssl.endpoint.identification.algorithm=HTTPS"));
    ...
    public void testWithPlainListenersWithoutAuth()  {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "listener.name.replication-9096.ssl.truststore.type=PKCS12",
                "listener.name.replication-9096.ssl.client.auth=required",
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,PLAIN-9092://0.0.0.0:9092",
                "advertised.listeners=CONTROLPLANE-9090://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096,PLAIN-9092://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9092",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,PLAIN-9092:PLAINTEXT",
                "control.plane.listener.name=CONTROLPLANE-9090",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
                "ssl.endpoint.identification.algorithm=HTTPS"));
    ...
    public void testKraftListenersMixedNodes()  {
        ...
        assertThat(configuration, isEquivalent("node.id=2",
                ...
                "listener.name.replication-9096.ssl.client.auth=required",
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,PLAIN-9092://0.0.0.0:9092",
                "advertised.listeners=REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096,PLAIN-9092://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9092",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,PLAIN-9092:PLAINTEXT",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
                "ssl.endpoint.identification.algorithm=HTTPS"));
    ...
    public void testKraftListenersBrokerAndControllerNodes()  {
        ...
        assertThat(configuration, isEquivalent("node.id=11",
                ...
                "listener.name.replication-9096.ssl.truststore.type=PKCS12",
                "listener.name.replication-9096.ssl.client.auth=required",
                "listeners=REPLICATION-9096://0.0.0.0:9096,PLAIN-9092://0.0.0.0:9092",
                "advertised.listeners=REPLICATION-9096://my-cluster-brokers-11.my-cluster-kafka-brokers.my-namespace.svc:9096,PLAIN-9092://my-cluster-brokers-11.my-cluster-kafka-brokers.my-namespace.svc:9092",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,PLAIN-9092:PLAINTEXT",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
                "ssl.endpoint.identification.algorithm=HTTPS"));
    ...
    public void testKraftOauthBrokerControllerAndMixedNodes()  {
        ...
        assertThat(configuration, isEquivalent("node.id=11",
            ...
            "listeners=REPLICATION-9096://0.0.0.0:9096,PLAIN-9092://0.0.0.0:9092",
            "advertised.listeners=REPLICATION-9096://my-cluster-brokers-11.my-cluster-kafka-brokers.my-namespace.svc:9096,PLAIN-9092://my-cluster-brokers-11.my-cluster-kafka-brokers.my-namespace.svc:9092",
            "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,PLAIN-9092:SASL_PLAINTEXT",
            "inter.broker.listener.name=REPLICATION-9096",
            "sasl.enabled.mechanisms=",
            "ssl.endpoint.identification.algorithm=HTTPS",
            "principal.builder.class=io.strimzi.kafka.oauth.server.OAuthKafkaPrincipalBuilder",
        ...
        assertThat(configuration, isEquivalent("node.id=14",
            ...
            "listener.name.replication-9096.ssl.client.auth=required",
            "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,PLAIN-9092://0.0.0.0:9092",
            "advertised.listeners=REPLICATION-9096://my-cluster-kafka-14.my-cluster-kafka-brokers.my-namespace.svc:9096,PLAIN-9092://my-cluster-kafka-14.my-cluster-kafka-brokers.my-namespace.svc:9092",
            "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,PLAIN-9092:SASL_PLAINTEXT",
            "inter.broker.listener.name=REPLICATION-9096",
            "sasl.enabled.mechanisms=",
            "ssl.endpoint.identification.algorithm=HTTPS",
    ...
    public void testWithPlainListenersWithSaslAuth()  {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "listener.name.replication-9096.ssl.client.auth=required",
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,PLAIN-9092://0.0.0.0:9092",
                "advertised.listeners=CONTROLPLANE-9090://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096,PLAIN-9092://dummy-advertised-address:1919",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,PLAIN-9092:SASL_PLAINTEXT",
                "control.plane.listener.name=CONTROLPLANE-9090",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
    ...
    public void testWithTlsListenersWithoutAuth()  {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "listener.name.replication-9096.ssl.truststore.type=PKCS12",
                "listener.name.replication-9096.ssl.client.auth=required",
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,TLS-9093://0.0.0.0:9093",
                "advertised.listeners=CONTROLPLANE-9090://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096,TLS-9093://dummy-advertised-address:1919",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,TLS-9093:SSL",
                "control.plane.listener.name=CONTROLPLANE-9090",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
                "ssl.endpoint.identification.algorithm=HTTPS",
    ...
    public void testWithExternalRouteListenersWithoutAuth()  {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "listener.name.replication-9096.ssl.truststore.type=PKCS12",
                "listener.name.replication-9096.ssl.client.auth=required",
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,EXTERNAL-9094://0.0.0.0:9094",
                "advertised.listeners=CONTROLPLANE-9090://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096,EXTERNAL-9094://dummy-advertised-address:1919",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,EXTERNAL-9094:SSL",
                "control.plane.listener.name=CONTROLPLANE-9090",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
                "ssl.endpoint.identification.algorithm=HTTPS",
    ...
    public void testWithExternalRouteListenersWithSaslAuth()  {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,EXTERNAL-9094://0.0.0.0:9094",
                "advertised.listeners=CONTROLPLANE-9090://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096,EXTERNAL-9094://dummy-advertised-address:1919",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,EXTERNAL-9094:SASL_SSL",
                "control.plane.listener.name=CONTROLPLANE-9090",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
                "ssl.endpoint.identification.algorithm=HTTPS",
    ...
    public void testPerBrokerWithExternalListeners()  {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "listener.name.replication-9096.ssl.client.auth=required",
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,EXTERNAL-9094://0.0.0.0:9094",
                "advertised.listeners=CONTROLPLANE-9090://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096,EXTERNAL-9094://my-lb.com:9094",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,EXTERNAL-9094:SSL",
                "control.plane.listener.name=CONTROLPLANE-9090",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
    ...
    public void testWithExternalListenersLoadBalancerWithoutTls()  {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,EXTERNAL-9094://0.0.0.0:9094",
                "advertised.listeners=CONTROLPLANE-9090://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096,EXTERNAL-9094://dummy-advertised-address:1919",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,EXTERNAL-9094:PLAINTEXT",
                "control.plane.listener.name=CONTROLPLANE-9090",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
                "ssl.endpoint.identification.algorithm=HTTPS"));
    ...
    public void testPerBrokerWithExternalListenersNodePortWithoutTls()  {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,EXTERNAL-9094://0.0.0.0:9094",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,EXTERNAL-9094:PLAINTEXT",
                "advertised.listeners=CONTROLPLANE-9090://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096,EXTERNAL-9094://${STRIMZI_NODEPORT_DEFAULT_ADDRESS}:31234",
                "control.plane.listener.name=CONTROLPLANE-9090",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
                "ssl.endpoint.identification.algorithm=HTTPS"));
    ...
    public void testCustomAuthConfigSetProtocolMapCorrectlyForsSslSasl() {
        ...
        assertThat(configuration, containsString("listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,CUSTOM-LISTENER-9092:SASL_SSL"));
    }
    ...
    public void testCustomAuthConfigSetProtocolMapCorrectlyForPlainSasl() {
        ...
        assertThat(configuration, containsString("listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,CUSTOM-LISTENER-9092:SASL_PLAINTEXT"));
    }
    ...
    public void testCustomAuthConfigSetProtocolMapCorrectlyForPlain() {
        ...
        assertThat(configuration, containsString("listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,CUSTOM-LISTENER-9092:PLAINTEXT"));
    }
    ...
    public void testCustomAuthConfigPrefixesUserProvidedConfig() {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,CUSTOM-LISTENER-9092://0.0.0.0:9092",
                "advertised.listeners=CONTROLPLANE-9090://my-cluster-kafka-2.my-cluster" +
                        "-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-kafka-2.my-cluster-kafka-brokers.my-namespace.svc:9096,CUSTOM-LISTENER-9092://dummy-advertised-address:1919",
                "listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,CUSTOM-LISTENER-9092:SASL_SSL",
                "control.plane.listener.name=CONTROLPLANE-9090",
                "inter.broker.listener.name=REPLICATION-9096",
                "sasl.enabled.mechanisms=",
                "ssl.endpoint.identification.algorithm=HTTPS",
    ...
    public void testWithTieredStorage() {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
                ...
                "remote.log.metadata.manager.listener.name=REPLICATION-9096",
                "rlmm.config.remote.log.metadata.common.client.bootstrap.servers=test-cluster-1-kafka-brokers:9096",
        ...
        for (KafkaMetadataConfigurationState state : KafkaMetadataConfigurationState.values()) {
            ...
            if (state.isPreMigrationToKRaft()) {
                ...
                if (state.isZooKeeperToPostMigration()) {
                    assertThat(configuration, containsString("listener.name.replication-9096"));
                    assertThat(configuration, containsString("listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL"));
                    assertThat(configuration, containsString("inter.broker.listener.name=REPLICATION-9096"));
                } else {
                    assertThat(configuration, not(containsString("listener.name.replication-9096")));
                    assertThat(configuration, containsString("listener.security.protocol.map=CONTROLPLANE-9090:SSL"));
                    assertThat(configuration, not(containsString("inter.broker.listener.name=REPLICATION-9096")));
                }
            ...
            if (state.isZooKeeperToMigration()) {
                ...
                assertThat(configuration, containsString("listeners=CONTROLPLANE-9090://0.0.0.0:9090,REPLICATION-9096://0.0.0.0:9096,PLAIN-9092://0.0.0.0:9092"));
                assertThat(configuration, containsString("advertised.listeners=CONTROLPLANE-9090://my-cluster-brokers-0.my-cluster-kafka-brokers.my-namespace.svc:9090,REPLICATION-9096://my-cluster-brokers-0.my-cluster-kafka-brokers.my-namespace.svc:9096,PLAIN-9092://my-cluster-brokers-0.my-cluster-kafka-brokers.my-namespace.svc:9092"));
                ...
                assertThat(configuration, containsString("listeners=REPLICATION-9096://0.0.0.0:9096,PLAIN-9092://0.0.0.0:9092"));
                assertThat(configuration, containsString("advertised.listeners=REPLICATION-9096://my-cluster-brokers-0.my-cluster-kafka-brokers.my-namespace.svc:9096,PLAIN-9092://my-cluster-brokers-0.my-cluster-kafka-brokers.my-namespace.svc:9092"));
                assertThat(configuration, not(containsString("control.plane.listener.name=CONTROLPLANE-9090")));
            }
            assertThat(configuration, containsString("listener.security.protocol.map=CONTROLPLANE-9090:SSL,REPLICATION-9096:SSL,PLAIN-9092:PLAINTEXT"));
            assertThat(configuration, containsString("inter.broker.listener.name=REPLICATION-9096"));
        }
    }
    ...
    public void testWithStrimziQuotas() {
        ...
        assertThat(configuration, isEquivalent("broker.id=2",
            ...
            "client.quota.callback.static.kafka.admin.bootstrap.servers=my-personal-cluster-kafka-brokers:9096",
