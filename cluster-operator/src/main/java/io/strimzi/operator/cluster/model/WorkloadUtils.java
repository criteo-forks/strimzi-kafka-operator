...
public class WorkloadUtils {
    ...
    public static Pod createStatefulPod(
        ...
        Pod pod = new PodBuilder()
                ...
                .withNewSpec()
                    ...
                    .withServiceAccountName(template != null && template.getServiceAccountName() != null ? template.getServiceAccountName() : serviceAccountName)
    ...
    public static PodTemplateSpec createPodTemplateSpec(
        ...
        return new PodTemplateSpecBuilder()
                ...
                .endMetadata()
                .withNewSpec()
                    .withServiceAccountName(template != null && template.getServiceAccountName() != null ? template.getServiceAccountName() : workloadName)
                    .withEnableServiceLinks(template != null ? template.getEnableServiceLinks() : null)
                    .withAffinity(affinity)
                    .withInitContainers(initContainers)
                    .withContainers(containers)
    ...
    public static Pod createPod(
        ...
        return new PodBuilder()
                ...
                .withNewSpec()
                    ...
                    .withServiceAccountName(template != null && template.getServiceAccountName() != null ? template.getServiceAccountName() : name)
                    .withEnableServiceLinks(template != null ? template.getEnableServiceLinks() : null)
                    .withAffinity(affinity)
                    .withInitContainers(initContainers)
                    .withContainers(containers)
